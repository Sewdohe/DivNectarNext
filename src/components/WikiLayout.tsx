...
export default function WikiLayout({ children }: React.PropsWithChildren) {
    ...
    return (
        ...
        <Transition.Root show={sidebarOpen} as={Fragment}>
          <Dialog as="div" className="relative z-50 lg:hidden" onClose={setSidebarOpen}>
            <Transition.Child
              ...
              leaveTo="opacity-0"
            >
              <div className="fixed inset-0 bg-navBG opacity-50 backdrop-blur-md" />
            </Transition.Child>
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
          {/* Sidebar component, swap this element with another sidebar if you like */}
          <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-navBG px-6">
            <div className="flex h-16 shrink-0 items-center">
              <img
                className="h-8 w-auto"
                src="/cn-logo.png"
            ...
            <nav className="flex flex-1 flex-col">
              <ul role="list" className="flex flex-1 flex-col gap-y-7">
                ...
                <li className="-mx-6 mt-auto">
                  ...
                  >
                    <img
                      className="h-8 w-8 rounded-full bg-navBG"
        ...
        <button type="button" className="-m-2.5 p-2.5 fixed z-50 top-20 right-10 text-sapphire lg:hidden" onClick={() => setSidebarOpen(true)}>
